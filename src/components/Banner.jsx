...
const [movie,setMovie]= useState()       //create state for using data outside
  ...
  return (
    <div style={{height:'600px',backgroundImage:`url(${base_url}${movie?.backdrop_path})`,backgroundSize:'cover',backgroundAttachment:'fixed',backgroundPosition:'center'}}>
        <div className="banner-content">
            ...
            <button className='btn border-white ms-3'>More Info <i class="fa-solid fa-play fa-rotate-90 bg-transparent"></i></button>
